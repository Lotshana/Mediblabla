  ...
  <div class="grid sm:grid-cols-2 sm:items-center gap-8">
    <div class="sm:order-2">
      <div class="relative pt-[50%] sm:pt-[100%] rounded-lg">
        <img class="w-full h-full absolute top-0 left-0 object-cover rounded-lg" src="../assets/medic-2.jpg" alt="Image Description">
      </div>
    </div>
    <!-- End Col -->
    ...
    <div class="sm:order-1">
      ...
      <h2 class="text-2xl font-bold md:text-3xl lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight text-darkblue">
        <a class="hover:text-lightblue" href="#">
      ...
      <div class="mt-5">
        <a class="inline-flex items-center gap-x-1.5 text-darkblue hover:text-lightblue decoration-2 hover:underline font-medium" href="#">
          Lire la suite
  ...
  <div class="grid lg:grid-cols-2 lg:gap-y-16 gap-10">
    ...
    <a class="group rounded-xl overflow-hidden" href="#">
      <div class="sm:flex">
        ...
        <div class="grow mt-4 sm:mt-0 sm:ml-6 px-4 sm:px-0">
          <h3 class="text-xl font-semibold text-gray-800 text-darkblue hover:text-lightblue">
            Studio by Preline
          </h3>
          <p class="mt-3 text-darkblue">
            Produce professional, reliable streams easily leveraging Preline's innovative broadcast studio
          </p>
          <p class="mt-4 inline-flex items-center gap-x-1.5 text-darkblue hover:text-lightblue decoration-2 hover:underline font-medium">
            Lire la suite
            <svg class="w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M5.27921 2L10.9257 7.64645C11.1209 7.84171 11.1209 8.15829 10.9257 8.35355L5.27921 14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            </svg>
    ...
    <a class="group rounded-xl overflow-hidden" href="#">
      <div class="sm:flex">
        ...
        <div class="grow mt-4 sm:mt-0 sm:ml-6 px-4 sm:px-0">
          <h3 class="text-xl font-semibold text-darkblue hover:text-lightblue">
