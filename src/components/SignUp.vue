      ...
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-darkblue">Inscription</h1>
          ...
          <div class="mt-5">
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <!-- Form Group -->
                <div>
                  <label for="confirm-password" class="block text-sm mb-2 dark:text-white">Confirmation Mot de passe</label>
                  <div class="relative">
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="confirm-password-error">Mot de passe non identiques</p>
                </div>
                <!-- End Form Group -->
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-3">
                    <label for="remember-me" class="text-sm dark:text-white">J'accepte les <a class="text-blue-600 decoration-2 hover:underline font-medium" href="#">conditions générales d'utilisation</a></label>
                  </div>
                </div>
                <!-- End Checkbox -->

                <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-beige text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">Inscription</button>
              </div>
            </form>
            <!-- End Form -->
          </div>
